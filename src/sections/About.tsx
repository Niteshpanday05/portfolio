    ...
    <div className="pb-20 lg:py-28">
      <div className="container">
        <SectionHeader
          ...
          description="Explore my journey, my work, and the inspiration behind what I create."
        />
        <div className="mt-20 flex flex-col gap-8 ">
          ...
          <div className="grid gap-8 grid-cols-1 md:grid-cols-5 lg:grid-cols-3 ">
            ...
            -translate-y-1/2 rounded-full bg-gradient-to-r
             from-emerald-300 to-sky-400 after:content-[''] after:absolute after:inset-0
