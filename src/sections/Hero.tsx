  ...
  return (
    <div className="py-28 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <HeroOrbit size={520} rotation={-42} shouldOrbit orbitDuration="34s" shouldSpin spinDuration="6s">
        ...
        <HeroOrbit size={620} rotation={-5} shouldOrbit orbitDuration="40s" shouldSpin spinDuration="6s">
          <div className="size-2 rounded-full bg-emerald-300/20" />
        </HeroOrbit>
